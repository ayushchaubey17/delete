...
export default function Hero3() {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <img src="https://images.pexels.com/photos/4819076/pexels-photo-4819076.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" className="max-w-sm rounded-lg shadow-2xl" />
    <div>
